...
__all__ = [
    ...
    "create_emb_for_encoder_and_decoder", "create_rnn_cell", "create_rnn_cell_multi"
...
def create_rnn_cell_multi(unit_type, num_units, num_layers, num_residual_layers,
                            forget_bias, dropout, mode, num_gpus, base_gpu=0,
                            single_cell_fn=None):
      """Create multi-layer RNN cell.
      ...
      # else:  # Multi layers
      return tf.contrib.rnn.MultiRNNCell(cell_list), cell_list[0]
